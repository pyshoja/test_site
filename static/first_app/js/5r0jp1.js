...
var paramsend=jQuery(this).attr('name');
var param=jQuery(this).attr('value');
...
type: 'POST',
url: MyAjax.ajaxurl,
data: {"action": "post_word_count", "dname":name, "param":param},
...
type: 'POST',
url: MyAjax.ajaxurl,
data: {"action": "post_like_count", "dname":name, "param":param},
success: function(data){
}});
});
});
jQuery(document).ready(function(t){t(".activity-content .wpulike .counter a").addClass("button"),t(document).on("click",".wp_ulike_btn",function(a){var e=t(this).data("ulike-type"),u=t(this).data("ulike-status"),s=t(this).data("ulike-id"),i=t(a.target).parent();""!=s&&jQuery.ajax({type:"POST",url:ulike_obj.ajaxurl,data:{action:"wp_ulike_process",id:s,type:e},beforeSend:function(){i.html('<a class="loading"></a><span class="count-box">...</span>')},success:function(t){1==u&&i.html("<a data-ulike-id='"+s+"' data-ulike-type='"+e+"' data-ulike-status='2' class='wp_ulike_btn unlike text button'>"+ulike_obj.text_after_like+"</a><span class='count-box'>"+t+"</span>"),2==u&&i.html(1==ulike_obj.return_initial_after_unlike?"image"==ulike_obj.button_type?"<a data-ulike-id='"+s+"' data-ulike-type='"+e+"' data-ulike-status='1' class='wp_ulike_btn image button'></a><span class='count-box'>"+t+"</span>":"<a data-ulike-id='"+s+"' data-ulike-type='"+e+"' data-ulike-status='1' class='wp_ulike_btn unlike text button'>"+ulike_obj.button_text+"</a><span class='count-box'>"+t+"</span>":"<a data-ulike-id='"+s+"' data-ulike-type='"+e+"' data-ulike-status='"+u+"' class='wp_ulike_btn unlike text button'>"+ulike_obj.text_after_unlike+"</a><span class='count-box'>"+t+"</span>"),3==u&&i.html("<a class='image button' title='You Liked This'></a><span class='count-box'>"+t+"</span>"),4==u&&("image"==ulike_obj.button_type?i.html("<a class='image button' title='You Liked This'></a><span class='count-box'>"+t+"</span>"):"text"==ulike_obj.button_type&&i.html("<a class='text unlike button' title='You Liked This'>"+ulike_obj.button_text+"</a><span class='count-box'>"+t+"</span>"))}})})});
(function($){
...
$.validator.classRuleSettings.password={ password: true };})(jQuery);
jQuery(document).ready(function(){
